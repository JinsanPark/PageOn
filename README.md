...
* **프로젝트 설명:** 외부 API와 연동하여 웹소설, 웹툰, 도서를 리뷰하고 추천하는 웹 기반 커뮤니티 서비스입니다.
* **개발 기간:** 2024.09.30 ~ 2024.11.12
* **주요 성과:** 멀티캠퍼스 프로젝트 경연 '우수상' 수상
* **팀 구성:** 총 6명
* **원본 저장소:**  https://github.com/selinakk/PageOn
...
- 외부 웹툰 플랫폼의 API (만화규장각 Open API) 를 호출하여 웹툰 데이터를 수집하고, 서비스에 맞는 형식으로 파싱하는 데이터 수집 모듈을 개발했습니다.
